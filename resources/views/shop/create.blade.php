    ...
    <div class="w-full h-[85vh] flex justify-center items-center">
        <div class="create-card flex flex-col justify-center items-center gap-4 border-2 rounded px-24 py-12">
            <div class="create-head text-center">
                <h1 class="text-3xl mb-1">Create product</h1>
            </div>
            @if(session('status'))
            ...
            <form action="" method="POST">
                ...
                <div class="create-body flex flex-col gap-1 justify-center">
                    <div class="form-input flex flex-col gap-1">
                        ...
                        <input autocomplete="off" class="bg-slate-100 px-4 py-1 rounded" name="name" id="name" type="text">
                    </div>
                    <div class="form-input flex flex-col gap-1">
                    ...
                    <div class="form-input flex flex-col gap-1">
                        ...
                        <input autocomplete="off" class="bg-slate-100 px-4 py-1 rounded" name="price" id="price" type="number">
                    </div>
                    <div class="form-input flex flex-col gap-1">
                        <label for="stock">Stock</label>
                        <input autocomplete="off" class="bg-slate-100 px-4 py-1 rounded" name="stock" id="stock" type="number">
                    </div>
                    <div class="form-input flex flex-col gap-1">
                        <label for="thumbnail">Thumbnail (url)</label>
                        <input autocomplete="off" class="bg-slate-100 px-4 py-1 rounded" name="thumbnail" id="thumbnail" type="text">
                    </div>
                </div>
